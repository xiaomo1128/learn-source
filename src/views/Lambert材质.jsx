    ...
    const $ = {
      ...
      datGui () {
        ...
        gui.addColor({ color: 0x1890ff }, 'color').onChange( val => {
          _this.material.color = new THREE.Color(val)
        })
        gui.add(_this.material, 'opacity', 0, 1, 0.1)
        gui.add(_this.material, 'side', ['FrontSide', 'BackSide', 'DoubleSide'])
        gui.add(_this.material, 'wireframe')
