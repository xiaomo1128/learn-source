  ...
  useEffect(() => {
    const $ = {
      ...
      createObjects () {
        ...
        const aoTexture = this.textureLoader.load('/src/assets/textures/2.jpg') // OA贴图
        const bumpTexture = this.textureLoader.load('/src/assets/textures/3.jpg') // 凹凸贴图
        const normalTexture = this.textureLoader.load('/src/assets/textures/4.jpg') // 法线贴图
        const roughnessTexture = this.textureLoader.load('/src/assets/textures/4.jpg') // 光滑度贴图
        ...
        const boxMaterial = new THREE.MeshStandardMaterial({
          ...
          normalMap: normalTexture,
          roughnessMap: roughnessTexture,
          displacementMap: bumpTexture, // 位移贴图 =凹凸贴图
          // wireframe: true,
        })
